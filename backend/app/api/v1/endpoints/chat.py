...
def _build_system_prompt(
    ...
    parts = [
        ...
        "You are a highly capable AI assistant — like ChatGPT, Gemini, or Claude. "
        ...
        "You are also embedded in the DocLens AI Platform - an AI-powered document "

        "document intelligence and data extraction system. When users ask about the platform, "
