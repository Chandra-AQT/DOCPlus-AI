...
def _fallback_schema(parsed_doc: dict, domain_hint: str) -> dict:
    ...
    # No hardcoded "always include" fields — the schema is entirely driven
    # by what the AI generates and what columns exist in the document.
    # The user controls what to extract via the schema they upload/create.
